...
constants <- list(M=M,J=J,n.cells=data$constants$n.cells,n.cells.x=data$constants$n.cells.x,
...
config.nodes <- c('beta0.lam','beta1.lam','sigma','rsf.beta') #will add block updates for density and detection parameters below
...
#Add block RW update, if posteriors correlated. AF_slice efficient, too, with only 1 occasion.
